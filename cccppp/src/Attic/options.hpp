//===- HackedOptionsParser.h - common options for clang tools -*- C++ -*-=====//
//
...
public:
  ...
  HackedOptionsParser(int &argc, const char **argv,
  ...
  static llvm::Expected<HackedOptionsParser>
